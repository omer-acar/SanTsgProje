...
namespace SanTsgProje.Application.Models.Responses
{
    public class ReservationDetailResponse
    {
        ...
        public class Reservationinfo
        {
            ...
            public string buyerReservationNumber { get; set; }
            ...
            public Gsacommission gsaCommission { get; set; }
        ...
        public class Service1
        {
            ...
            public string supplierReservationNumber { get; set; }
            ...
            public DateTime serviceStatusDate { get; set; }
